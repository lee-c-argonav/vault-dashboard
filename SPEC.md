...
```jsonc
{
  ...
  "health": {
    ...
    "broken": [ { "source": "40-Daily/2026-07-22", "link": "project-x-sync" } ]
  },
...
```jsonc
{
  ...
  "text": "Think through user roles and permissions in `project-x` …",  // raw inline md
  "html": "Think through user roles and permissions in <code>project-x</code> …",
  "done": false,
  "source": "40-Daily/2026-07-22.md",
  "line": 23,
  "section": "Todos",              // nearest preceding "## " heading
  "project": "project-x",               // slug or null
  ...
  "links": ["project-x"],               // wikilink targets in the line
  "obsidian": "obsidian://…"
}
```
...
- Resolution, Obsidian-style: exact relative path match first, then unique
  ...
  entry — the vault currently has one, `[[project-y]]`.
...
```
┌─────────────────────────────────────────────────────────────────────────┐
│ ▚ VAULT-HUD  YOUR-VAULT · 2026-07-24 · FRI   OPEN STALE  DUE OVER DONE  │
│                                              30    06   00   00   00    │
├─────────────────────────────────────────────────────────────────────────┤
│ CPU 10%   GPU 52%   MEM 49%   BAT 100%                                  │
├────────────────────────────────────────────┬────────────────────────────┤
│ ▌FOCUS               40-DAILY/2026-07-24   │ ▌STALE                     │
│ MAIN FOCUS — PROJECT-X SYNC                │      06                    │
│ LOAD ▌▌▌▌▌▌▎▎▎▎▎▎▎▎▎▎▎▎▎▎▎▎                │ OLDEST 02D — SHIP TH…      │
├────────────────────────────────────────────┼────────────────────────────┤
│ ▌TODOS   30 OPEN · 04 SCHED · 30 DONE      │ ▌LATTICE  53N · 112E       │
│ ▸ OVERDUE                        05        │         ●   ╱│╲   ●        │
│  ☐ Ship the parser fix    02D              │       ●───●───●            │
│ ▸ TODAY                          05        │         ╲│╱    ○ ○         │
│  ☐ Draft the memo   PROJECT-X              │                            │
│ ▸ UPCOMING                       06        │                            │
│  ☐ Prep the deck    DUE 07-27              │                            │
│ BACKLOG · BY PROJECT                       │ ▌DECISIONS            06   │
│ ▸ PROJECT-X                      07        │  07-22 Reconcile the …     │
│ ▸ PROJECT-Y                      04        │  07-22 Gate needs a d…     │
│ ▸ DONE (collapsed)               30        │                            │
├────────────────────────────────────────────┼────────────────────────────┤
│ ▌ROLLED OVER      06 · OLDEST 02D          │ ▌INTEGRITY  02B · 09O      │
│ 02D Ship the parser fix                    │ UNRESOLVED                 │
│ 01D Diff-scope the migration lint          │ [[project-y]] ×3  3 NOT…   │
├────────────────────────────────────────────┴────────────────────────────┤
│ ! Ambiguous wikilink [[project-y]] — more than one note has that basena…│
├─────────────────────────────────────────────────────────────────────────┤
│ NOTES 53 · LINKS 152 · INBOX 00 · ORPHAN 09 · BROKEN 02 · SYNC · ● LIVE │
└─────────────────────────────────────────────────────────────────────────┘
```
...
| groups | PROJECT-X 10 · UNASSIGNED 21 · PROJECT-Y 04 · PROJECT-Z 03 |
| graph | 46 nodes · 67 edges · 94 links |
| health | 18 orphans · 0 stale30 · 3 broken (all `[[project-y]]`) · 1 warning |
